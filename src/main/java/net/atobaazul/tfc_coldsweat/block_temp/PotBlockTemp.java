...
public class PotBlockTemp extends BlockTemp
{
    ...
    public double getTemperature(Level level, LivingEntity entity, BlockState state, BlockPos pos, double distance)
    {
        ...
        if (be instanceof PotBlockEntity) {
            return CSMath.blend(Temperature.convert(((PotBlockEntity) be).getTemperature(), Temperature.Units.C, Temperature.Units.MC, true), 0, distance, 0.5, 16)/30;
        }
        return 0.0;
    }
